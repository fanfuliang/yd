...
@Data
@ToString
@Table(name = "term_click_history")
@TableName("term_click_history")
public class ClickHistory implements Serializable {
    ...
    */
    ...
    public ClickHistory(String id, String statusValue) {
        this.id = id;
