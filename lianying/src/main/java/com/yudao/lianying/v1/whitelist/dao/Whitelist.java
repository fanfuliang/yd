package com.yudao.lianying.v1.whitelist.dao;
...
public class Whitelist implements Serializable {
    ...
    */
    ...
    @Column(columnDefinition = "varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '登录名'")
    @ApiModelProperty("登录名")
    private String loginName;

    @TableField("mobile")
    @Column(columnDefinition = "varchar(11) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '手机号'")
    @ApiModelProperty("手机号")
    private String mobile;

    public Whitelist(String id, String statusValue) {
        this.id = id;
