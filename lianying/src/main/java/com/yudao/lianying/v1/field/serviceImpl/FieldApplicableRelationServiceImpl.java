...
import com.yudao.lianying.v1.field.api.FieldApplicableRelationServiceApi;
import com.yudao.lianying.v1.field.biz.FieldApplicableRelationBusiness;
...
@RestController
@Slf4j
public class FieldApplicableRelationServiceImpl implements FieldApplicableRelationServiceApi {
    @Autowired
    private FieldApplicableRelationBusiness fieldApplicableRelationBusiness;

    @Override
    public Result saveAuto(FieldApplicableRelationVO entityVO) {
        try {
            return ResultUtil.success(fieldApplicableRelationBusiness.saveAuto(entityVO));
    ...
    public Result removeByIdAuto(String ids) {
        try {
            fieldApplicableRelationBusiness.removeByIdAuto(ids);
    ...
    @Override
    public Result modifyAllColumnInObjectAuto(FieldApplicableRelationModifyVO1 modifyVO1) {
        try {
            fieldApplicableRelationBusiness.modifyAllColumnInObjectAuto(modifyVO1);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result modifyByIdAuto(String ids, String modifyFieldNames, String modifyFieldValues) {
        try {
            ...
            fieldApplicableRelationBusiness.modifyByIdAuto(idList, modifyFieldNameArray, modifyFieldValueArray);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result getByIdAuto(String id) {
        try {
            return ResultUtil.success(fieldApplicableRelationBusiness.getByIdAuto(id));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    public Result pageAuto(String keyword, String filterFieldNames, String filterFieldValues, String orderBy, Integer pageNum, Integer pageSize) {
        try {
            ...
            return ResultUtil.success(fieldApplicableRelationBusiness.pageAuto(new Page<>(pageNum, pageSize), keyword, filterFieldNameArray, filterFieldValueArray, orderBy));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
