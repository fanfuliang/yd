...
import com.yudao.lianying.v1.term.api.EntryLangServiceApi;
import com.yudao.lianying.v1.term.biz.EntryLangBusiness;
...
@RestController
@Slf4j
public class EntryLangServiceImpl implements EntryLangServiceApi {
    @Autowired
    private EntryLangBusiness entryLangBusiness;

    @Override
    public Result saveAuto(EntryLangVO entityVO) {
        try {
            return ResultUtil.success(entryLangBusiness.saveAuto(entityVO));
    ...
    public Result removeByIdAuto(String ids) {
        try {
            entryLangBusiness.removeByIdAuto(ids);
    ...
    @Override
    public Result modifyAllObjectFeildAuto(EntryLangModifyVO1 modifyVO1) {
        try {
            entryLangBusiness.modifyAllObjectFeildAuto(modifyVO1);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result modifyByIdAuto(String ids, String modifyFieldNames, String modifyFieldValues) {
        try {
            ...
            entryLangBusiness.modifyByIdAuto(idList, modifyFieldNameArray, modifyFieldValueArray);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result getByIdAuto(String id) {
        try {
            return ResultUtil.success(entryLangBusiness.getByIdAuto(id));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    public Result pageAuto(String keyword, String filterFieldNames, String filterFieldValues, String orderBy, Integer pageNum, Integer pageSize) {
        try {
            ...
            return ResultUtil.success(entryLangBusiness.pageAuto(new Page<>(pageNum, pageSize), keyword, filterFieldNameArray, filterFieldValueArray, orderBy));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    @Override
    public Result getCommonLang(String account) {
        try {
            return ResultUtil.success(entryLangBusiness.getCommonLang(account));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
