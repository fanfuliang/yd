...
import com.yudao.lianying.v1.term.api.ClickHistoryServiceApi;
import com.yudao.lianying.v1.term.biz.ClickHistoryBusiness;
...
@RestController
@Slf4j
public class ClickHistoryServiceImpl implements ClickHistoryServiceApi {
    @Autowired
    private ClickHistoryBusiness clickHistoryBusiness;

    @Override
    public Result saveAuto(ClickHistoryVO entityVO) {
        try {
            return ResultUtil.success(clickHistoryBusiness.saveAuto(entityVO));
    ...
    public Result removeByIdAuto(String ids) {
        try {
            clickHistoryBusiness.removeByIdAuto(ids);
    ...
    @Override
    public Result modifyAllColumnInObjectAuto(ClickHistoryModifyVO1 modifyVO1) {
        try {
            clickHistoryBusiness.modifyAllColumnInObjectAuto(modifyVO1);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result modifyBatchByIdAuto(@RequestBody List<ModifyVO> modifyVOList) {
        try {
            clickHistoryBusiness.modifyBatchByIdAuto(modifyVOList);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result getByIdAuto(String id) {
        try {
            return ResultUtil.success(clickHistoryBusiness.getByIdAuto(id));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    public Result pageAuto(String searchFieldNames, String keyword, @DateTimeFormat(pattern = "yyyy-MM-dd") Date beginTime, @DateTimeFormat(pattern = "yyyy-MM-dd") Date endTime, String filterFieldNames, String filterFieldValues, String orderBy, Integer pageNum, Integer pageSize) {
        try {
            ...
            return ResultUtil.success(clickHistoryBusiness.pageAuto(new Page<>(pageNum, pageSize), searchFieldNames, keyword, beginTime, endTime, filterFieldNameArray, filterFieldValueArray, orderBy));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    @Override
    public Result hotTerm() {
        try {
            return ResultUtil.success(clickHistoryBusiness.hotTerm());
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
