...
import com.yudao.lianying.v1.field.api.FieldServiceApi;
...
@RestController
@Slf4j
public class FieldServiceImpl implements FieldServiceApi {
    @Autowired
    private FieldBusiness fieldBusiness;

    @Override
    public Result saveAuto(FieldVO entityVO) {
        try {
            return ResultUtil.success(fieldBusiness.saveAuto(entityVO));
    ...
    public Result removeByIdAuto(String ids) {
        try {
            fieldBusiness.removeByIdAuto(ids);
    ...
    @Override
    public Result modifyAllObjectFeildAuto(FieldModifyVO1 modifyVO1) {
        try {
            fieldBusiness.modifyAllObjectFeildAuto(modifyVO1);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result modifyByIdAuto(String ids, String modifyFieldNames, String modifyFieldValues) {
        try {
            ...
            fieldBusiness.modifyByIdAuto(idList, modifyFieldNameArray, modifyFieldValueArray);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result getByIdAuto(String id) {
        try {
            return ResultUtil.success(fieldBusiness.getByIdAuto(id));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    public Result pageAuto(String keyword, String filterFieldNames, String filterFieldValues, String orderBy, Integer pageNum, Integer pageSize) {
        try {
            ...
            return ResultUtil.success(fieldBusiness.pageAuto(new Page<>(pageNum, pageSize), keyword, filterFieldNameArray, filterFieldValueArray, orderBy));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    @Override
    public Result relateApplicable(String fieldId, String applicableToIds) {
        try {
            fieldBusiness.relateApplicable(fieldId, applicableToIds);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
