package com.yudao.lianying.v1.field.dao;
...
@Data
@ToString
@Table(name = "applicable_to")
@TableName("applicable_to")
public class ApplicableTo implements Serializable {
    ...
    */
    ...
    public ApplicableTo(String id, String statusValue) {
        this.id = id;
