package com.yudao.lianying.v1.checkOrder.serviceImpl;
...
import com.yudao.lianying.v1.checkOrder.api.CheckOrderServiceApi;
import com.yudao.lianying.v1.checkOrder.biz.CheckOrderBusiness;
...
@RestController
@Slf4j
public class CheckOrderServiceImpl implements CheckOrderServiceApi {
    @Autowired
    private CheckOrderBusiness checkOrderBusiness;

    @Override
    public Result saveAuto(CheckOrderVO entityVO) {
        try {
            return ResultUtil.success(checkOrderBusiness.saveAuto(entityVO));
    ...
    public Result removeByIdAuto(String ids) {
        try {
            checkOrderBusiness.removeByIdAuto(ids);
    ...
    @Override
    public Result modifyAllColumnInObjectAuto(CheckOrderModifyVO1 modifyVO1) {
        try {
            checkOrderBusiness.modifyAllColumnInObjectAuto(modifyVO1);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result modifyBatchByIdAuto(@RequestBody List<ModifyVO> modifyVOList) {
        try {
            checkOrderBusiness.modifyBatchByIdAuto(modifyVOList);
            return ResultUtil.success();
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
    ...
    public Result getByIdAuto(String id) {
        try {
            return ResultUtil.success(checkOrderBusiness.getByIdAuto(id));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    public Result pageAuto(String searchFieldNames, String keyword, @DateTimeFormat(pattern = "yyyy-MM-dd") Date beginTime, @DateTimeFormat(pattern = "yyyy-MM-dd") Date endTime, String filterFieldNames, String filterFieldValues, String orderBy, Integer pageNum, Integer pageSize) {
        try {
            ...
            return ResultUtil.success(checkOrderBusiness.pageAuto(new Page<>(pageNum, pageSize), searchFieldNames, keyword, beginTime, endTime, filterFieldNameArray, filterFieldValueArray, orderBy));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
    ...
    @Override
    public Result getLastOrder(String account) {
        try {
            return ResultUtil.success(checkOrderBusiness.getLastOrder(account));
        } catch (YudaoException e) {
            log.error("", e);
            return ResultUtil.error(e);
        } catch (Exception e) {
